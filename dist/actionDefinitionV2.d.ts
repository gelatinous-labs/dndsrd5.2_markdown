...
export type ActivationType = 'action' | 'bonusAction' | 'reaction' | 'magicAction' | 'free' | 'special' | 'passive' | 'triggered';
export type ActionDefinitionKind = 'attack' | 'save' | 'multiattack' | 'spellcast' | 'generic';
export type ActionSection = 'traits' | 'actions' | 'bonusActions' | 'reactions' | 'legendaryActions' | 'spells';
...
export type EffectApplication = 'onHit' | 'onFailSave' | 'onSucceedSave' | 'always';
